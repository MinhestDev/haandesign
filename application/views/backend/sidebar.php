        		...
        		<nav class="sidebar-nav">
        			<ul id="sidebarnav">
        				...
        				<?php } else { ?>
        					...
        					<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Phần mềm </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>Payroll/Salary_List"> ChatGPT </a></li>
                                <li><a href="<?php echo base_url(); ?>Payroll/Generate_salary"> Gợi ý ảnh </a></li>
                            </ul>
                        	</li>
